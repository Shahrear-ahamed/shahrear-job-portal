...
const jobsSchema = mongoose.Schema(
  {
    ...
    deadLine: {
      type: Date,
      required: [true, "Please add deadline of this job"],
    },
    hiringManager: {
      name: {
        type: String,
        required: [true, "Please provide hiring manager name"],
      },
      hUId: {
        type: ObjectId,
        ref: "Users",
    ...
    location: {
      type: String,
      required: [true, "you have to add job location"],
      lowercase: true,
    },
    jobType: {
      type: String,
      enum: {
        ...
        message: "job type is not allow for {VALUE}",
      },
    },
    salary: {
      type: Number,
    ...
    description: {
      ...
      required: [
        true,
        "Please add your company job description for user interaction",
      ],
    },
    totalOpening: {
      type: Number,
